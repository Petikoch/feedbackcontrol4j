...
See link:src/test/groovy/ch/petikoch/libs/feedbackcontrol4j/EventBasedFeedbackControlLoopTest.groovy[executable documentation in src/test/groovy] for
...
dependencies {
    compile 'ch.petikoch.libs:feedbackcontrol4j:0.1.0' // or whatever explicit version
...
----
        <dependency>
            ...
            <version>0.1.0</version> <!-- or whatever version -->
